...
function load_log(filename::String; path="")
    ...
    syslog = StructArray{SysState{P}}((table.time, table.t_sim, table.sys_state, table.e_mech, table.orient, 
                                       table.elevation, table.azimuth, table.l_tether, table.v_reelout, table.force, 
                                       table.depower, table.steering, table.heading, table.course, table.v_app, 
                                       table.v_wind_gnd, table.v_wind_200m, table.v_wind_kite, table.vel_kite, table.X, 
                                       table.Y, table.Z, table.var_01, table.var_02, table.var_03, 
