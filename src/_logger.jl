...
@with_kw mutable struct Logger{P, Q}
    ...
    turn_rates_vec::Vector{MVector{3, Float32}} = zeros(MVector{3, Float32}, Q)
    elevation_vec::Vector{MyFloat} = zeros(MyFloat, Q)
    azimuth_vec::Vector{MyFloat} = zeros(MyFloat, Q)
    l_tether_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    v_reelout_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    force_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    ...
    aero_force_b_vec::Vector{MVector{3, MyFloat}} = zeros(MVector{3, MyFloat}, Q)
    aero_moment_b_vec::Vector{MVector{3, MyFloat}} = zeros(MVector{3, MyFloat}, Q)
    twist_angles_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    ...
    set_torque_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    set_speed_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
    set_force_vec::Vector{MVector{4, MyFloat}} = zeros(MVector{4, MyFloat}, Q)
